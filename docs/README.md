# Documentação — Metal Slug Demake

Índice da documentação do projeto. Ordem sugerida de leitura para quem está entrando agora:

1. [01-toolchain-setup.md](01-toolchain-setup.md) — o que precisa estar instalado e por quê.
2. [02-build-e-execucao.md](02-build-e-execucao.md) — como compilar, rodar e debugar.
